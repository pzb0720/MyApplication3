...
import com.example.wanandroid.mvp.model.home.HomeModel;
...
import com.example.wanandroid.util.UpdateItemTypeUtil;
...
import static com.example.wanandroid.constant.SpConstant.SP_USER_LOGIN;
import static com.example.wanandroid.constant.SpConstant.SP_USER_NAME;
import static com.example.wanandroid.constant.SpConstant.SP_USER_PASSWORD;
...
//                CookiesManager.clearAllCookies();
    ...
    private void login() {
        ...
        final String userName = SpUtils.getString(mIView.getBindActivity(), SP_USER_NAME, "");
        final String userPassword = SpUtils.getString(mIView.getBindActivity(), SP_USER_PASSWORD, "");
                ...
                .subscribe(new Observer<DataResponse<User>>() {  //订阅
                    ...
                    public void onNext(DataResponse<User> value) {
                        ...
                        if (value.getErrorCode() == 0) {
                            ...
                            SpUtils.putString(mIView.getBindActivity(), "SP_USER_NAME", userName);
                            SpUtils.putString(mIView.getBindActivity(), "SP_USER_PASSWORD", userPassword);
                            SpUtils.putBoolean(mIView.getBindActivity(), SP_USER_LOGIN, true);
                        } else {
                            mIView.showToast("自动登陆失败");
                            SpUtils.putString(mIView.getBindActivity(), "SP_USER_NAME", "");
                            SpUtils.putString(mIView.getBindActivity(), "SP_USER_PASSWORD", "");
                            SpUtils.putBoolean(mIView.getBindActivity(), SP_USER_LOGIN, false);
                        }
                    }
