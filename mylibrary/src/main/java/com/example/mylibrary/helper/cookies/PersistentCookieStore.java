package com.example.mylibrary.helper.cookies;
...
public class PersistentCookieStore {
    ...
    public PersistentCookieStore() {
        cookiePrefs = AppUtils.getContext().getSharedPreferences(COOKIE_PREFS, 0);
        cookies = new HashMap<>();
...
//        Log.i("哇哈哈", "cookie.name() + \"@\" + cookie.domain()  :      " + cookie.name() + "@" + cookie.domain());
        return cookie.name() + "@" + cookie.domain();
    }

    public void add(HttpUrl url, Cookie cookie) {
        Log.i("哇哈哈", "add.name " + getCookieToken(cookie));
